...
LABEL io.modelcontextprotocol.server.name="io.github.Hbin-Zhuang/mcp-feishu-doc"
...
RUN mkdir -p /var/log/mcp-feishu-doc && chown -R bun:bun /var/log/mcp-feishu-doc
...
ENV LOGS_DIR="/var/log/mcp-feishu-doc"
